...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.28 2016-09-23 06:58:33 GMT")
...
{	switch (p->type)
	...
	case SOAP_TYPE___tdn__Hello:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct __tdn__Hello*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct __tdn__Hello*>(p->ptr));
		break;
	case SOAP_TYPE___tdn__Bye:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct __tdn__Bye*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct __tdn__Bye*>(p->ptr));
		break;
	case SOAP_TYPE___tdn__Probe:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct __tdn__Probe*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct __tdn__Probe*>(p->ptr));
		break;
	case SOAP_TYPE__wsa__EndpointReference:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct wsa__EndpointReferenceType*>(p->ptr));
...
__tdn__Probe::__tdn__Probe()
{
	soap_default___tdn__Probe(NULL, this);
}
...
SOAP_FMAC1 struct __tdn__Probe * SOAP_FMAC2 soap_instantiate___tdn__Probe(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct __tdn__Probe);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct __tdn__Probe, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct __tdn__Probe location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE___tdn__Probe, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
__tdn__Bye::__tdn__Bye()
{
	soap_default___tdn__Bye(NULL, this);
}
...
SOAP_FMAC1 struct __tdn__Bye * SOAP_FMAC2 soap_instantiate___tdn__Bye(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct __tdn__Bye);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct __tdn__Bye, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct __tdn__Bye location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE___tdn__Bye, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
__tdn__Hello::__tdn__Hello()
{
	soap_default___tdn__Hello(NULL, this);
}
...
SOAP_FMAC1 struct __tdn__Hello * SOAP_FMAC2 soap_instantiate___tdn__Hello(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct __tdn__Hello);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct __tdn__Hello, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct __tdn__Hello location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE___tdn__Hello, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
__wsdd__ResolveMatches::__wsdd__ResolveMatches()
{
	soap_default___wsdd__ResolveMatches(NULL, this);
}
...
SOAP_FMAC1 struct __wsdd__ResolveMatches * SOAP_FMAC2 soap_instantiate___wsdd__ResolveMatches(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct __wsdd__ResolveMatches);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct __wsdd__ResolveMatches, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct __wsdd__ResolveMatches location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE___wsdd__ResolveMatches, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
__wsdd__Resolve::__wsdd__Resolve()
{
	soap_default___wsdd__Resolve(NULL, this);
}
...
SOAP_FMAC1 struct __wsdd__Resolve * SOAP_FMAC2 soap_instantiate___wsdd__Resolve(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct __wsdd__Resolve);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct __wsdd__Resolve, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct __wsdd__Resolve location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE___wsdd__Resolve, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
__wsdd__ProbeMatches::__wsdd__ProbeMatches()
{
	soap_default___wsdd__ProbeMatches(NULL, this);
}
...
SOAP_FMAC1 struct __wsdd__ProbeMatches * SOAP_FMAC2 soap_instantiate___wsdd__ProbeMatches(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct __wsdd__ProbeMatches);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct __wsdd__ProbeMatches, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct __wsdd__ProbeMatches location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE___wsdd__ProbeMatches, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
__wsdd__Probe::__wsdd__Probe()
{
	soap_default___wsdd__Probe(NULL, this);
}
...
SOAP_FMAC1 struct __wsdd__Probe * SOAP_FMAC2 soap_instantiate___wsdd__Probe(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct __wsdd__Probe);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct __wsdd__Probe, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct __wsdd__Probe location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE___wsdd__Probe, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
__wsdd__Bye::__wsdd__Bye()
{
	soap_default___wsdd__Bye(NULL, this);
}
...
SOAP_FMAC1 struct __wsdd__Bye * SOAP_FMAC2 soap_instantiate___wsdd__Bye(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct __wsdd__Bye);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct __wsdd__Bye, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct __wsdd__Bye location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE___wsdd__Bye, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
__wsdd__Hello::__wsdd__Hello()
{
	soap_default___wsdd__Hello(NULL, this);
}
...
SOAP_FMAC1 struct __wsdd__Hello * SOAP_FMAC2 soap_instantiate___wsdd__Hello(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct __wsdd__Hello);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct __wsdd__Hello, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct __wsdd__Hello location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE___wsdd__Hello, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
wsdd__AppSequenceType::wsdd__AppSequenceType()
{
	soap_default_wsdd__AppSequenceType(NULL, this);
}
...
SOAP_FMAC1 struct wsdd__AppSequenceType * SOAP_FMAC2 soap_instantiate_wsdd__AppSequenceType(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct wsdd__AppSequenceType);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct wsdd__AppSequenceType, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct wsdd__AppSequenceType location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_wsdd__AppSequenceType, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
wsdd__SigType::wsdd__SigType()
{
	soap_default_wsdd__SigType(NULL, this);
}
...
SOAP_FMAC1 struct wsdd__SigType * SOAP_FMAC2 soap_instantiate_wsdd__SigType(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct wsdd__SigType);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct wsdd__SigType, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct wsdd__SigType location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_wsdd__SigType, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
wsdd__SecurityType::wsdd__SecurityType()
{
	soap_default_wsdd__SecurityType(NULL, this);
}
...
SOAP_FMAC1 struct wsdd__SecurityType * SOAP_FMAC2 soap_instantiate_wsdd__SecurityType(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct wsdd__SecurityType);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct wsdd__SecurityType, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct wsdd__SecurityType location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_wsdd__SecurityType, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
wsdd__ScopesType::wsdd__ScopesType()
{
	soap_default_wsdd__ScopesType(NULL, this);
}
...
SOAP_FMAC1 struct wsdd__ScopesType * SOAP_FMAC2 soap_instantiate_wsdd__ScopesType(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct wsdd__ScopesType);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct wsdd__ScopesType, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct wsdd__ScopesType location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_wsdd__ScopesType, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
wsdd__ResolveMatchType::wsdd__ResolveMatchType()
{
	soap_default_wsdd__ResolveMatchType(NULL, this);
}
...
SOAP_FMAC1 struct wsdd__ResolveMatchType * SOAP_FMAC2 soap_instantiate_wsdd__ResolveMatchType(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct wsdd__ResolveMatchType);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct wsdd__ResolveMatchType, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct wsdd__ResolveMatchType location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_wsdd__ResolveMatchType, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
wsdd__ResolveMatchesType::wsdd__ResolveMatchesType()
{
	soap_default_wsdd__ResolveMatchesType(NULL, this);
}
...
SOAP_FMAC1 struct wsdd__ResolveMatchesType * SOAP_FMAC2 soap_instantiate_wsdd__ResolveMatchesType(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct wsdd__ResolveMatchesType);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct wsdd__ResolveMatchesType, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct wsdd__ResolveMatchesType location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_wsdd__ResolveMatchesType, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
wsdd__ResolveType::wsdd__ResolveType()
{
	soap_default_wsdd__ResolveType(NULL, this);
}
...
SOAP_FMAC1 struct wsdd__ResolveType * SOAP_FMAC2 soap_instantiate_wsdd__ResolveType(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct wsdd__ResolveType);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct wsdd__ResolveType, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct wsdd__ResolveType location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_wsdd__ResolveType, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
wsdd__ProbeMatchType::wsdd__ProbeMatchType()
{
	soap_default_wsdd__ProbeMatchType(NULL, this);
}
...
SOAP_FMAC1 struct wsdd__ProbeMatchType * SOAP_FMAC2 soap_instantiate_wsdd__ProbeMatchType(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct wsdd__ProbeMatchType);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct wsdd__ProbeMatchType, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct wsdd__ProbeMatchType location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_wsdd__ProbeMatchType, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
wsdd__ProbeMatchesType::wsdd__ProbeMatchesType()
{
	soap_default_wsdd__ProbeMatchesType(NULL, this);
}
...
SOAP_FMAC1 struct wsdd__ProbeMatchesType * SOAP_FMAC2 soap_instantiate_wsdd__ProbeMatchesType(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct wsdd__ProbeMatchesType);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct wsdd__ProbeMatchesType, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct wsdd__ProbeMatchesType location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_wsdd__ProbeMatchesType, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
wsdd__ProbeType::wsdd__ProbeType()
{
	soap_default_wsdd__ProbeType(NULL, this);
}
...
SOAP_FMAC1 struct wsdd__ProbeType * SOAP_FMAC2 soap_instantiate_wsdd__ProbeType(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct wsdd__ProbeType);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct wsdd__ProbeType, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct wsdd__ProbeType location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_wsdd__ProbeType, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
wsdd__ByeType::wsdd__ByeType()
{
	soap_default_wsdd__ByeType(NULL, this);
}
...
SOAP_FMAC1 struct wsdd__ByeType * SOAP_FMAC2 soap_instantiate_wsdd__ByeType(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct wsdd__ByeType);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct wsdd__ByeType, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct wsdd__ByeType location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_wsdd__ByeType, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
wsdd__HelloType::wsdd__HelloType()
{
	soap_default_wsdd__HelloType(NULL, this);
}
...
SOAP_FMAC1 struct wsdd__HelloType * SOAP_FMAC2 soap_instantiate_wsdd__HelloType(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct wsdd__HelloType);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct wsdd__HelloType, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct wsdd__HelloType location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_wsdd__HelloType, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
wsa__Relationship::wsa__Relationship()
{
	soap_default_wsa__Relationship(NULL, this);
}
...
wsa__ServiceNameType::wsa__ServiceNameType()
{
	soap_default_wsa__ServiceNameType(NULL, this);
}
...
wsa__ReferenceParametersType::wsa__ReferenceParametersType()
{
	soap_default_wsa__ReferenceParametersType(NULL, this);
}
...
wsa__ReferencePropertiesType::wsa__ReferencePropertiesType()
{
	soap_default_wsa__ReferencePropertiesType(NULL, this);
}
...
wsa__EndpointReferenceType::wsa__EndpointReferenceType()
{
	soap_default_wsa__EndpointReferenceType(NULL, this);
}
