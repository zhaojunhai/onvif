...
inline struct __tdn__Probe * soap_new___tdn__Probe(struct soap *soap, int n = -1) { return soap_instantiate___tdn__Probe(soap, n, NULL, NULL, NULL); }
...
inline struct __tdn__Bye * soap_new___tdn__Bye(struct soap *soap, int n = -1) { return soap_instantiate___tdn__Bye(soap, n, NULL, NULL, NULL); }
...
inline struct __tdn__Hello * soap_new___tdn__Hello(struct soap *soap, int n = -1) { return soap_instantiate___tdn__Hello(soap, n, NULL, NULL, NULL); }
